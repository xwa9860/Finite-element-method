function [K, R] = make_K_R_adp(connect, P, Ne, nodeCoord, fFunc, l_BC_type, value_Left, r_BC_type, value_Right)
...
for e=1:Ne
    ...
    Jacob = 0.5 * (coordElement(2) - coordElement(1));
